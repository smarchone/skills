...
## 5. Documentation
- **`docs/language.md`**: The central source of truth for the ubiquitous language. Defines canonical nouns (Things), verbs (Actions), and relationships. This vocabulary must be strictly consistent, as it directly drives domain modelling and code generation.
