...
The diagram is **one system-wide asset** at `docs/domain/mermaid.md`. Every `domain-model` run **amends it in place**: add or refresh this domain's subgraph and any bridge edges. Never produce a per-domain copy.
