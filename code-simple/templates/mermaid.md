...
> Conventions: Single, system-wide asset. Never create per-domain copies of this diagram.
...
|---|---|---|---|
| <DomainX> | `X` | teal | `docs/models/<domainx>.md` |
| <DomainO> | `O` | indigo | `docs/models/<domaino>.md` |
